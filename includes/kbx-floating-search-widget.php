		...
		<div class="kbx-fes-widget-main">
			<div class="beacon-wrapper">
				<form class="search-form" id="ajax-fes-search-form">
					<div>
						<input class="fes-search-form-input" placeholder="<?php _e('Search the knowledge base', 'kbx-qc') ?>" autocomplete="off" offset="18" type="text">
					</div>
					<a href="#" class="fes-search-form-submit">
